...
-- CreateEnum
CREATE TYPE "AttendanceStatus" AS ENUM ('PRESENT', 'LATE', 'ABSENT', 'SICK', 'LEAVE', 'WFH');
...
CREATE TABLE "Attendance" (
    ...
    "latCheckIn" DOUBLE PRECISION,
    "longCheckIn" DOUBLE PRECISION,
    "latCheckOut" DOUBLE PRECISION,
    "longCheckOut" DOUBLE PRECISION,
    "photoCheckIn" TEXT,
    "photoCheckOut" TEXT,
